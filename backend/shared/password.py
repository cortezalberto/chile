...
# - bcrypt: industry-standard secure hashing
# - deprecated="auto": allows seamless migration from old schemes
pwd_context = CryptContext(
    schemes=["bcrypt"],
    deprecated="auto",
    bcrypt__rounds=12,  # 2^12 iterations, good balance of security/performance
)
